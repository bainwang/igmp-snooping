 ...
 * Output     :
 * Returns    :      
 * writer     : bain.wang@outlook.com, 2011-06-05
 *------------------------------------------------------------------------
*/
 ...
 * Output:
 * Returns:      
 * writer:      bain.wang@outlook.com, 2011-06-07
 *------------------------------------------------------------------------
*/
 ...
 * Output:
 * Returns:      
 * writer:      bain.wang@outlook.com, 2016-09-14
 *------------------------------------------------------------------------
*/
	...
	)
{
	...
	strncpy(hostname, (I8_T *)ptrCliValue->value, 32 - 1);
	...
	bc_cli_set_cmdpath(sessionID, CLI_MOD_PRIVI_PATH, CLI_MOD_PRIVI_PROM, NULL);
    bc_cli_set_cmdpath(sessionID, CLI_MOD_GLBCFG_PATH, CLI_MOD_GLBCFG_PROM, NULL);

	memset(&tmp_bnr, 0x00, sizeof(BANNER_PRMPT_BANNER_T));
	CLI_BNR_Get_PromptBannerInfo(&tmp_bnr);
	...
	)
{
	...
	tmp_bnr.cmd_prompt.bUserName = FALSE;
	memset(tmp_bnr.cmd_prompt.string, 0x00, sizeof(tmp_bnr.cmd_prompt.string));
	memcpy(tmp_bnr.cmd_prompt.string, DEV_NAME, sizeof(tmp_bnr.cmd_prompt.string));
