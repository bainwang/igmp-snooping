    ...
    )
{
    ...
    ptrFilterPara = (CFG_FILTER_PARA_T *)CLI_MISC_Calloc(1, sizeof(CFG_FILTER_PARA_T));
    ...
    while (*ptr_parser != '\0')
    {
         ...
         || !memcmp(ptr_parser, s_cfg_flt_tkn[CFG_FLT_TYPE_EXC], strlen(s_cfg_flt_tkn[CFG_FLT_TYPE_EXC])))
        {
            ...
            ptrFilterPara->next = (CFG_FILTER_PARA_T *) CLI_MISC_Calloc(1, sizeof(CFG_FILTER_PARA_T));
        ...
        else if (*ptr_parser == '"')
        {
            ...
            else
            {
                ...
                {
                    ptrFilterPara->ptr_filter_string = (CFG_FILTER_STRING_T *)CLI_MISC_Calloc(1, sizeof(CFG_FILTER_STRING_T));
                ...
                else
                {
                    ...
                    ptrFilterString->next = (CFG_FILTER_STRING_T *)CLI_MISC_Calloc(1, sizeof(CFG_FILTER_STRING_T));
                    ptrFilterString = ptrFilterString->next;
                }
                ptrFilterString->ptr_filter_string = (I8_T *)CLI_MISC_Calloc(1, (UI32_T)(ptr_double_quote - ptr_parser) + 1);
    ...
    )
{
    ...
    line_string = (I8_T *)CLI_MISC_Calloc(1, line_len + 1);
