...
#elif defined BC_PT_D12G
#define  CLI_VKEY_INSERT 		(CLI_VKEY_EDIT_KEY_BASE + 0x01L)
#define  CLI_VKEY_HOME   		(CLI_VKEY_EDIT_KEY_BASE + 0x02L)
#define  CLI_VKEY_PAGEUP 		(CLI_VKEY_EDIT_KEY_BASE + 0x03L)
#define  CLI_VKEY_DELETE 		(CLI_VKEY_EDIT_KEY_BASE + 0x04L)
#define  CLI_VKEY_END    		(CLI_VKEY_EDIT_KEY_BASE + 0x05L)
#define  CLI_VKEY_PAGEDOWN 		(CLI_VKEY_EDIT_KEY_BASE + 0x06L)
#elif defined BC_PTC88C
#define  CLI_VKEY_INSERT 		(CLI_VKEY_EDIT_KEY_BASE + 0x01L)
#define  CLI_VKEY_HOME   		(CLI_VKEY_EDIT_KEY_BASE + 0x02L)
#define  CLI_VKEY_PAGEUP 		(CLI_VKEY_EDIT_KEY_BASE + 0x03L)
#define  CLI_VKEY_DELETE 		(CLI_VKEY_EDIT_KEY_BASE + 0x04L)
