...
/*******************************************************************************
  ...
  [History]:
	...
	---------- --------------										 ----------
	2014-04-21	Modified 											  wangbin
	2012-09-28	Modified 											  wangbin
	            添加调试打印宏定义
	2012-09-20  Created                                               wangbin
*******************************************************************************/
...
/*
 * If CLI_WORD_WITH_HELP defined, CLI can support detail help in ? help
 * system, comments in CLI syntax command description (Which is enclosed by
 * # in the mode "# ENGLISH-HELP # LOCAL-HELP #", If LOCAL-HELP omitted, CLI
 * kernel will use Englis help in ? help system. if both of them are omitted,
 * CLI kernel will only show the word name in ? help system. If this macro not
 * defined, CLI kernel will skip all chars between #).
 */
#define CLI_WORD_WITH_HELP

/*
 * If CLI_WORD_WITH_LOCAL_HELP CLI_WORD_WITH_HELP and defined, CLI can support
 * detail local help in ? help system, else, only support English help.
 */
#define CLI_WORD_WITH_LOCAL_HELP
