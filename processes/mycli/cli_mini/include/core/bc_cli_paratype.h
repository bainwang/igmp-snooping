 ...
 * HISTORY:
 * -----------------------------------------------------------------------------
 * Version 1.0 -- 2009-Mar-18 by wangbin
 * [NEW FEATURE]
 * <DESCRIPTION> Create
 *============================================================================*/
...
{ /* CLI_TYPES_* */
	...
	CLI_TYPES_MULTIWORD, /* add for compatibility with CLI G1, just like "aaa bbb ccc" */
	...
	CLI_TYPES_ENUMLIST_STRING, /* Ex: month <MONTH> */
	...
	CLI_TYPES_STACKINGPORTLIST, /* Ex: 1-10, 1:1-1:10... */
	...
	CLI_TYPES_CLIG1_DATE, /* add for compatibility with CLI G1 */
	CLI_TYPES_CLIG1_TIME, /* add for compatibility with CLI G1 */
	CLI_TYPES_CLIG1_TIME2, /* add for compatibility with CLI G1 */
	CLI_TYPES_CLIG1_DAYLIST, /* add for compatibility with CLI G1 */
	CLI_TYPES_CLIG1_MEDIA, /* add for compatibility with CLI G1 */
	CLI_TYPES_HEX,  /* 0xaabbcc */
	CLI_TYPES_BINARY, /* 0b01000 */
	CLI_TYPES_OID, /* string */
	CLI_TYPES_IPV6ADDR,
	CLI_TYPES_IPV6NETADDR,
	CLI_TYPES_IPV6MULTICASTADDR, /* multicast ipv6 address add for compatibility with CLI G1 */
	CLI_TYPES_IPV6MULTICASTADDRCHAIN, /*multicast ipv6 address chain add for compatibility with CLI G1 */
	CLI_TYPES_FLOAT,
 ...
 *	 user command.
 * INPUT:
 *	 session_id -- Session ID created by CLI_API_CreateSession
