...
/******************************************************************************\
  ...
  Others     : 
\******************************************************************************/
void snmp_fhEntityExtentMIB_init()
{
	snmp_fhEntityState_scalar_init();
	snmp_fhEntityBoardPfmTable_init();
	snmp_fhEntityIfPfmTable_init();
	snmp_fhEntityOpticalModuleInfoTable_init();
	snmp_fhEntitySlotInfoTable_init();
	snmp_fhEntityBoardInfoTable_init();
}
