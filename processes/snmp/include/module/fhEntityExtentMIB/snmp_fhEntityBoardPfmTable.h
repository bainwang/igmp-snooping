...
#define FHENTITYBOARDPFMTABLE_OID_LEN				12		/*表的OID个数*/
#define FHENTITYBOARDPFMTABLE_OID_NODE_LEN		(FHENTITYBOARDPFMTABLE_OID_LEN+2)/*叶子结点OID个数*/
#define FHENTITYBOARDPFMTABLE_OID_FULL_LEN		(FHENTITYBOARDPFMTABLE_OID_NODE_LEN+FHENTITYBOARDPFMTABLE_INDEX_NUM)/*完整结点OID个数*/
