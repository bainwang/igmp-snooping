...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr/local/netsnmp' '--with-default-snmp-version=3' '--with-sys-contact=bain.wang@outlook.com.uestc@gmail.com' '--with-sys-location=China' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/net-snmp' '--enable-mfd-rewrites'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/usr/local/netsnmp/share/snmp/mibs"
...
#define SNMPLIBPATH "/usr/local/netsnmp/lib/snmp"
#define SNMPSHAREPATH "/usr/local/netsnmp/share/snmp"
#define SNMPCONFPATH "/usr/local/netsnmp/etc/snmp"
#define SNMPDLMODPATH "/usr/local/netsnmp/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "bain.wang@outlook.com.uestc@gmail.com"

/* system location */
#define NETSNMP_SYS_LOC "China"
